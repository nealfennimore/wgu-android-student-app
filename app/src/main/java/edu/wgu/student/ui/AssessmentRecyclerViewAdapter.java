...
public class AssessmentRecyclerViewAdapter extends RecyclerView.Adapter<AssessmentRecyclerViewAdapter.ViewHolder> {
    ...
    public AssessmentRecyclerViewAdapter(Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textView.setText(assessment.getTitle());
    }
    ...
    public interface ItemClickListener {
        void onItemClick(View view, AssessmentEntity item, int position);
    }
}