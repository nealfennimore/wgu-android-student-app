...
@Database(entities = {TermEntity.class, CourseEntity.class, AssessmentEntity.class, MentorEntity.class, CourseAssessmentJoinEntity.class, CourseMentorJoinEntity.class, TermCourseJoinEntity.class}, version = 1)
